      ...
      <div className='content-line-2'>
        ...
        <div className='content-line-4'>
          <Row gutter={22}>
            ...
            <Col className="gutter-row-1" span={4}>
            <div>
              <img src='https://cdn.hoanghamobile.com/i/productlist/dsp/Uploads/2020/09/17/apple-iphone-11-64gb-6.1.jpg' alt='anh-3' className='anh' />
              <h4>Apple Iphone 14 Pro Max</h4>
              <ul className='text-1'>
...
export default DienThoaiContent